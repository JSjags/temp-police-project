...
import arrow from "../../assets/cases/arrow.svg";
...
const Cases = () => {
  ...
  const customDateFormat = (stringDate) => {
    try {
  ...
  const [dateRange, setDateRange] = useState([
    paramsStartDate !== null
      ? new Date(customDateFormat(paramsStartDate))
      : null,
    paramsEndDate !== null ? new Date(customDateFormat(paramsEndDate)) : null,
  ]);
  ...
  return (
    ...
    >
      <Await resolve={useGetCasesQuery(routeParams)}>
        {(casesData) => (
          <>
            {casesData.isLoading && (
              <div className="flex justify-center items-center w-full h-[90vh]">
            ...
            {!!(
              casesData.isSuccess && casesData?.currentData?.data?.cases.length
            ) && (
              <div className="px-4">
                {/* First Section */}
                <div className="rounded-xl font-poppins mb-4 flex flex-wrap gap-5">
                  ...
                  <div className="p-7 bg-white flex gap-x-5 items-center w-full min-[400px]:w-[clamp(200px,100%,280px)]">
                    ...
                    <div className="font-nunito text-project-light-black">
                      ...
                      <p className="text-sm">Total Arrest</p>
                    </div>
                  </div>
                  {/* second card */}
                  <div className="p-7 bg-white flex gap-x-5 items-center w-full min-[400px]:w-[clamp(200px,100%,280px)]">
                    ...
                    <div className="font-nunito text-project-light-black">
                      <p className="text-2xl font-extrabold">
                        {casesData?.currentData?.data.cases.reduce(
                          (acc, curr) =>
                            curr.can_afford_lawyer ? acc + 1 : acc,
                          0
                        )}
                      </p>
                      <p className="text-sm">With Legal Rep</p>
                    </div>
                  </div>
                  {/* third card */}
                  <div className="p-7 bg-white flex gap-x-5 items-center  w-full min-[400px]:w-[clamp(200px,100%,280px)]">
                    ...
                    <div className="font-nunito text-project-light-black">
                      <p className="text-2xl font-extrabold">
                        {casesData?.currentData?.data.cases.reduce(
                          (acc, curr) =>
                            curr.can_afford_lawyer ? acc : acc + 1,
                          0
                        )}
                      </p>
                      <p className="text-sm">Without Legal Rep</p>
                    </div>
                  </div>
                </div>
                ...
                {!!searchParams.toString().length && (
                  <div className="my-2">
                    ...
                    >
                      <BsArrowLeft />
                      <span className="font-poppins font-medium text-xs text-project-light-black">
                ...
                <div className="flex flex-wrap font-poppins mb-2 gap-5 items-end">
                  <div>
                    <p className="text-sm text-project-light-black">Date:</p>
                ...
                <img src={chevron} />
                  ...
                  <div className="h-fit bg-white relative">
                    ...
                    <button
                      ...
                      className="absolute top-1/2 -translate-y-1/2 right-0 hover:bg-project-blue group h-full w-6 flex justify-center items-center"
                    >
                      <img src={search} className="group-hover:invert" />
                    </button>
                  </div>
                  <button
                    aria-label="Filter"
          ...
          />
            ...
            {casesData.isSuccess &&
                        ...
                        <p className="text-2xl font-extrabold">
                          {casesData?.currentData?.data?.cases.reduce(
                            (accumulator, currentValue) =>
                              accumulator +
                              (currentValue.can_afford_lawyer ? 1 : 0),
                            0
                          )}
                        </p>
                        <p className="text-sm">With Legal Rep</p>
                      ...
                      <div className="font-nunito text-project-light-black">
                        <p className="text-2xl font-extrabold">
                          {casesData?.currentData?.data?.cases.reduce(
                            (accumulator, currentValue) =>
                              accumulator +
                              (currentValue.can_afford_lawyer ? 0 : 1),
                            0
                          )}
                        </p>
                        <p className="text-sm">Without Legal Rep</p>
              ...
              >
                ...
                <img src={chevron} />
                  ...
                  {/* Third Section */}
                  <div className="p-5 bg-white font-poppins mt-5 sm:mt-2">
                    <div className="flex justify-center items-center w-full h-[clamp(300px,50vh,360px)] mt-5">
                      <p
                        className="font-poppins justify-center items-center font-semibold text-xl text-project-light-black
                "
                      >
                        No cases found.
                      </p>
            ...
            {casesData.isError && (
              ...
              >
                ...
                {/* Third Section */}
                <div className="p-5 bg-white font-poppins mt-5 sm:mt-2 px-4">
                  <div className="flex flex-col justify-center items-center w-full h-[clamp(300px,50vh,360px)] mt-5">
                    <div className="flex flex-col items-start mx-auto max-w-[480px]">
                      <p className="font-poppins justify-center items-center font-semibold text-project-light-black text-xl">
                        No recent cases found due to an error. Please ensure
                        that:
                      </p>
                      <ol className="mt-4 text-project-light-black list-decimal pl-4">
                        <li> You are connected to the internet.</li>
                        <li> You entered a valid date.</li>
                      </ol>
                    </div>
                  </div>
                </div>
